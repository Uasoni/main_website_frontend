<script>
    ...
    import CompetitiveMathematicsHeaderImage from '$lib/assets/resources/CompetitiveMathematicsHeaderImage.webp'
</script>
...
<div class="max-w-[1000px] mx-auto gap-4 flex flex-col py-6 px-10">
    ...
    <p class="text-lg leading-relaxed mb-5">
        Welcome to <i>CM101</i>, an introduction to what competitive mathematics is about, and how you can get started with it.
    </p>
    ...
    <div class="flex flex-col gap-2 w-[80%] mx-auto mb-5">
        <div class="w-full">
            <img
                    src={CompetitiveMathematicsHeaderImage}
                    alt="Competitive Mathematics Workspace"
                    class="w-full h-auto object-cover"
            />
        </div>
        <p class="text-sm text-gray-500 ml-auto">
            <i>Image credit: Quanta Magazine</i>
        </p>
    </div>
    ...
    <p class="text-lg leading-relaxed">
        Competitive mathematics differs from high-school and university mathematics since the difficulty of the problems lies in the fact that known concepts must be applied in clever and unique ways to solve them, even though not a great amount of theoretical knowledge is typically required.
        <br/><br/>
        As such, doing competitive mathematics helps develop strong problem solving skills, which are often seeked by employers (e.g. Optiver sponsors the Australian Maths Olympiad Program). Hence, it can assist in a future career that relies on mathematical ability, and more generally helps improve mathematical thinking. And of course, as mentioned earlier, it’s just plain fun!
    </p>
    ...
    <p class="text-lg leading-relaxed">
        ...
        <br/><br/>
        The most notable university maths competition in Australia is the <a href="https://www.simonmarais.org/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">Simon Marais Mathematics Competition</a>. The contests consist of two periods of exactly three hours each (including reading time), with a 90-minute break between the two sessions.
        <br/><br/>
        You can also sign up to various other international mathematics competition, some notable ones include <a href="https://www.imc-math.org.uk/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">International Mathematics Competition for University Students</a>. Though the registration process will be a lot more complicated than the SMMC.
    </p>
    ...
    <h1 class="text-4xl font-bold text-[#5b8ddb] tracking-tight">
        High School Competitive Mathematics
    </h1>
    ...
    <h1 class="text-4xl font-bold text-[#5b8ddb] tracking-tight">
        University Competitive Mathematics
    </h1>
    ...
    <ol class="list-decimal list-outside pl-5 text-lg leading-relaxed ml-5">
        <li>This is a really good book <a href="http://www.cms.zju.edu.cn/UploadFiles/AttachFiles/201082333637670.pdf" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">(Putnam and Beyond)</a> to get started , and it is enough to get you to a decent level when you’ve first started.</li>
        <li>Course Materials would do for Introductory level University CM too, the books mentioned in the list are complementary to the University courses.</li>
        <li>A beginner recommendation will be <a href="https://www.amazon.com.au/Art-Craft-Problem-Solving-2E/dp/0471789011" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">Art of Problem Solving</a>.</li>
        <li>Once you get the beginner level stuff down you can move onto doing past papers from <a href="http://kskedlaya.org/putnam-archive/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">Putnam Archive</a>.</li>
    </ol>
