...
<div class="max-w-[1000px] mx-auto gap-4 flex flex-col py-6 px-10">
    ...
    <p class="text-lg leading-relaxed mb-5">
        Welcome to <i>CP101</i>, an introduction to what competitive programming is about, and how you can get started with it.
    </p>
    ...
    <ol class="list-decimal list-outside pl-5 text-lg leading-relaxed ml-5">
        ...
        <li><b>Algorithms and data structures</b>, which we apply to solve problems.</li>
        <li><b>Implementation</b>, the process of writing and testing code.</li>
    </ol>
    ...
    <div class="flex flex-col gap-2 w-[80%] mx-auto mb-5">
        <div class="w-full">
            <img
                    src={CompetitiveProgrammingHeaderImage}
                    alt="Competitive Mathematics Workspace"
                    class="w-full h-auto object-cover"
            />
        </div>
        <p class="text-sm text-gray-500 ml-auto">
            <i>Image credit: ireneperezstudio</i>
        </p>
    </div>
    ...
    <p class="text-lg leading-relaxed mb-5">
        CPMSoc runs <b>workshops</b> and <b>contests</b> throughout the year, suitable for all experience levels. We are always happy to give advice and help out.
        <br/><br/>
        We also recommend taking <a href="https://www.handbook.unsw.edu.au/undergraduate/courses/2026/COMP4128?year=2026" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">COMP4128 (Programming Challenges)</a> when you are able to, as having the lecturer and tutors there to help you quickly is very useful.
        <br/><br/>
        The most notable university competition is the <a href="https://icpc.global/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">International Collegiate Programming Contest (ICPC)</a>. The contests are five hours long with roughly twelve problems, and you compete in teams of three. Generally there are three stages: the Preliminary, Regionals, and World Finals.
    </p>
    ...
    <div class="border-l-4 border-gray-200 pl-6 py-5">
        <p class="text-lg leading-relaxed mb-4">
            You have bought <span class="font-serif italic">N</span> identical flowers to arrange into three vases. As an expert in interior design, there are three important rules you must follow:
        </p>

        <ol class="list-decimal list-outside pl-5 space-y-2 text-lg mb-4 ml-4">
            <li>Every flower must go into one of the vases, since throwing flowers away is wasteful.</li>
            <li>Each vase must contain at least one flower, since an empty vase looks very odd.</li>
            <li>Each vase must contain a different number of flowers, so all the vases look different.</li>
        </ol>

        <p class="text-lg leading-relaxed">
            Given a value of <span class="font-serif italic">N</span>, print a possible way to arrange the flowers, or say that there is no way.
        </p>
    </div>

    <p class="text-lg leading-relaxed mb-5">
        For this problem, we have to write a program that reads an integer
        <span class="font-serif italic">N</span> as input, and outputs the number of flowers you want in each vase.
        <br/><br/>
        Go <a href="https://orac2.info/problem/3/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">here</a> for the full specifications (including some examples) and a place to submit your code, and see <a href="https://orac2.info/hub/train/aio-statement" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">this</a> for help reading the statement and solving the problem.
    </p>

    <h1 class="text-5xl font-bold text-[#5b8ddb] tracking-tight mb-4">
        Getting started
    </h1>
    ...
    <h1 class="text-4xl font-bold text-[#5b8ddb] tracking-tight mt-5">
        Learning algorithms and techniques
    </h1>
    <p class="text-lg leading-relaxed">
        There is a huge range of online resources to help you learn about algorithms, data structures and common approaches.
        <br/><br/>
        We recommend following a course such as the <a href="https://usaco.guide/" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline"><i>USACO Guide</i></a>, or a book such as the <a href="https://cses.fi/book/book.pdf" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline"><i>Competitive Programmer’s Handbook</i></a>.
    </p>
</div>